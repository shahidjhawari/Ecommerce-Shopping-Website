...
<div class="container-fluid pb-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner bg-light">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="<?php echo PRODUCT_IMAGE_SITE_PATH . $get_product['0']['image'] ?>" alt="Image">
                    </div>
                </div>
        ...
        <div class="col-lg-7 h-auto mb-30">
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <a class="btn btn-primary px-3" href="" onclick="manage_cart('<?php echo $get_product['0']['id'] ?>','add')"><b>Add To Cart</b></a>
                    <a class="btn btn-primary px-3 ml-2" href="" onclick="wishlist_manage('<?php echo $list['id'] ?>','add')"><b>Add To Favourite</b></a>
                </div>
    ...
    <!-- Add the product description, additional information, and reviews sections here using the PHP variables -->
</div>
<!-- Shop Detail End -->
